...
void prepair_data (){
	...
	//USART_TxChar('\n');
	// <--
	if((ADC0<50) && (490<ADC1) && (ADC1<530)) data_array[1]=0;
	// -->
	if((ADC0>1000) && (490<ADC1) && (ADC1<530)) data_array[1]=1;
	// tien trai
	if((ADC0<50) && (ADC1>950)) data_array[1]=2;
	// lui phai
	...
	// tien
	if((480<ADC0) && (ADC0<550) && (ADC1>1000)) data_array[1]=6;
	//lui
	if((480<ADC0) && (ADC0<550) && (ADC1<50)) data_array[1]=7;
	//none
